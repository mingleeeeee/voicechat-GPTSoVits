...
with open(f"./weight.json", 'r', encoding="utf-8") as file:
    ...
    # if isinstance(gpt_path,str):
    #     gpt_path = gpt_path
    # if isinstance(sovits_path,str):
...
def change_gpt_weights(gpt_path):
    gpt_path="/Users/mingli/Documents/sakaba/GPT-SoVITS/GPT_SoVITS/GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s1bert.ckpt"
